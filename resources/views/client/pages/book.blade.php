    ...
    <section class="mt-32 mb-12 container">
        ...
        <div class="flex flex-wrap -mx-8 mt-12 justify-center">
            <div class="page-content mt-8">
                ...
                <p> Otherwise information is excessive, there is a hint of typical emphasis on lineages, as per guesses
                    made
                    in Edo period, but the community does not seem to object to those...</p>
                <p> But there is quite a lot on observations regarding the style changes during the foundation of the
                    Soshu school,
                    kantei issues, and great wealth of information regarding the statistics on signatures, gathered both
                    from
                ...
                <p> The book is a very substantial improvement over Dr. Honma's. Markus Sesko did a very good job with a
                    final edit; in the present form it is extremely impressive both in terms of analysis and objects
                    presented.
                    Detailed information about the Soshu school's early period, its reinterpretation and the resulting
                    great
                ...
                <p> As good as private collections go without venturing into Kokuho territory. The praise can be
                    repeated on and on, but it is really worth to bite the (price, weight, convenience) bullet and just
                    read it.</p>
                ...
                <p>In terms of the presence of the book not to mention the contents, it is just simply beautifully laid
                    out
                    and done to what is the highest Japanese standards. Sanae Sakamoto who is a really great artist did
                    the
                    calligraphy throughout the book as she did for me, and details like this are what makes it its own
                    piece
                    of craftsmanship. I wrote the forward for this and one of the things I said is that until you try to
                    make a book, you have no idea how hard it is to make a book. The details are so hard to nail down
                    and
                    the higher your goals are it gets exponentially harder to accomplish. When you are mixing things
                    like
                    nihonto photography which is hard enough on its own, with high level book construction, and getting
                    the
                ...
                <p>The price may seem high but the book is massive and just the printing cost alone of such a thing is
                    pretty much what the list price is. It's not something made for profit but is entirely a labor of
                    love
                ...
                <p>But what I can say from spending some time with it, is that it is an incredible book. Don't expect
                    some
                    thin lightweight coffee-table book here. This is HUGE. Weight is over 5kg of amazing photography and
                ...
                <p>It is a BIG book, and oozes class from the paper used to the binding and slipcase. Everything has
                    ...
                    could
                    imagine.</p>
                <p>Can't recommend this highly enough. This is destined to be a collector’s item in itself, and is the
                    next
                ...
                <p>I know it is not cheap. But once you have it, you will know why and never feel like you overspent. My
